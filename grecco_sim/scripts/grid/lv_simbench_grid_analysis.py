...
plt.plot(
    range(0, 96),
    total_load_active_power["total_load_active_power"][0:96],
    label="Load",
    color="blue",
)
plt.plot(
    range(0, 96),
    total_static_generation["total_static_generation"][0:96],
    label="Generation",
    color="red",
)
...
plt.plot(
    range(0, 672),
    total_load_active_power["total_load_active_power"][0:672],
    label="Load",
    color="blue",
)
plt.plot(
    range(0, 672),
    total_static_generation["total_static_generation"][0:672],
    label="Generation",
    color="red",
)
...
plt.plot(
    total_load_active_power.index,
    total_load_active_power["total_load_active_power"],
    label="Load",
    color="blue",
)
plt.plot(
    total_static_generation.index,
    total_static_generation["total_static_generation"],
    label="Generation",
    color="red",
)
